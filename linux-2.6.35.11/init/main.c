...
#if defined(CONFIG_MSTAR_TITANIA12)
#include "../arch/mips/mips-boards/titania12/chip_setup.h"
#elif defined(CONFIG_MSTAR_AMBER5) 
#include "../arch/mips/mips-boards/amber5/chip_setup.h"
#elif defined(CONFIG_MSTAR_JANUS2) 
#include "../arch/mips/mips-boards/janus2/chip_setup.h"
#else
#endif
...
#if defined(CONFIG_NVT_NT72558) && defined(CONFIG_NVT_MEMPROTECT)
#define PROTECT_REG_BASE       0xbd010100
/* ch0 [4:0], ch1 [9:5], ch2 [14:10] */
#define WT_PROTECT_0           *((volatile unsigned int *)(PROTECT_REG_BASE + 0x184))
/* ch3 [4:0], ch4 [9:5], ch5 [14:10] */
#define WT_PROTECT_1           *((volatile unsigned int *)(PROTECT_REG_BASE + 0x190))

#define WT_PROTECT_START1      *((volatile unsigned int *)(PROTECT_REG_BASE + 0x18))
#define WT_PROTECT_END1        *((volatile unsigned int *)(PROTECT_REG_BASE + 0x1c))
#define WT_PROTECT_START2      *((volatile unsigned int *)(PROTECT_REG_BASE + 0x20))
#define WT_PROTECT_END2        *((volatile unsigned int *)(PROTECT_REG_BASE + 0x24))
#define WT_PROTECT_START3      *((volatile unsigned int *)(PROTECT_REG_BASE + 0x28))
#define WT_PROTECT_END3        *((volatile unsigned int *)(PROTECT_REG_BASE + 0x2c))
#define WT_PROTECT_START4      *((volatile unsigned int *)(PROTECT_REG_BASE + 0x30))
#define WT_PROTECT_END4        *((volatile unsigned int *)(PROTECT_REG_BASE + 0x34))
#define WT_PROTECT_START5      *((volatile unsigned int *)(PROTECT_REG_BASE + 0x38))
#define WT_PROTECT_END5        *((volatile unsigned int *)(PROTECT_REG_BASE + 0x3c))
#define MAU_INTRPT_EN          *((volatile unsigned int *)(PROTECT_REG_BASE + 0x90))
#endif

static int __init kernel_init(void * unused)
{
#if defined(CONFIG_ARCH_SDP1004) || defined(CONFIG_ARCH_SDP1105)
	struct timespec vddefault_date;
#endif
	/*
...
#if defined(CONFIG_NVT_NT72558) && defined(CONFIG_NVT_MEMPROTECT)
        WT_PROTECT_START1 = (unsigned int)_text & 0x0FFFFFFF;
        WT_PROTECT_END1 = (unsigned int)(_etext - 4) & 0x0FFFFFFF;
        WT_PROTECT_START2 = (unsigned int)__start_rodata & 0x0FFFFFFF;
        WT_PROTECT_END2 = (unsigned int)(__end_rodata - 4) & 0x0FFFFFFF;
        WT_PROTECT_0 = 0xC63; // enable all channel first two bits for protect two ranges
        WT_PROTECT_1 = 0xC63; // enable all channel first two bits for protect two ranges
        MAU_INTRPT_EN = 1;
        printk("============================================================\n");
        printk("text   section range: 0x%08x ~ 0x%08x\n", (unsigned int)_text, (unsigned int)(_etext - 1));
        printk("rodata section range: 0x%08x ~ 0x%08x\n", (unsigned int)__start_rodata, (unsigned int)(__end_rodata - 1));
        printk("Novatek text and rodata section HW protection start.........\n");
        printk("============================================================\n");
#endif

#if defined(CONFIG_ARCH_SDP1004) || defined(CONFIG_ARCH_SDP1105)
	/* Sat Jan  1 00:00:00 UTC 2011 */
	vddefault_date.tv_sec = 1293840000;
	vddefault_date.tv_nsec = 0;
	do_settimeofday(&vddefault_date);
#endif
