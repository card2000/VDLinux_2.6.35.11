...
int main( int argc, char *argv[] )
{
	...
	sprintf( cmd_str, "arch/mips/boot/mkimage -n 'linux-2.6.30.9' -A mips -O linux -T kernel -C none -a 0x%08X -e 0x%08X -d vmlinux.bin vmlinux.img", (unsigned int)ker_dst_base, (unsigned int)ker_dst_entry );
	system( cmd_str );
