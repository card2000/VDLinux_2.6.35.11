...
#ifdef CONFIG_USB_NT72558_HCD
#include "ehci-NT72558.c"
#define PLATFORM_DRIVER         ehci_hcd_NT72558_driver
#include "ehci-NT725581.c"
#define PLATFORM_DRIVER_NT72558         ehci_hcd_NT725581_driver
#endif
...
static int __init ehci_hcd_init(void)
{
	...
	retval = platform_driver_register(&PLATFORM_DRIVER_NT72558);
	if (retval < 0)
		goto clean0;
#endif
...
clean0:
	...
	platform_driver_unregister(&PLATFORM_DRIVER_NT72558);
#endif
