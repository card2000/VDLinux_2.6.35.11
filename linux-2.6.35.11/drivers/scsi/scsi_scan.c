...
#ifdef SAMSUNG_PATCH_WITH_USB_HOTPLUG
	sdev->serial = scsi_default_serial_strs;		//add for usb serial number
	sdev->logicalnumber = scsi_0_logical_strs;		//add for usb logical number
	sdev->usbdevpath = scsi_usb_devpath_strs;	//add for usb device path 
#endif
	sdev->host = shost;
