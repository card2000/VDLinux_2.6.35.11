...
#define DDRB_BASE_ADDR                  0x80000000

//OSD Plane Physical AddressS
#define SDP83_GFX0_PHYWINBASE 	(DDRB_BASE_ADDR+0x07100000)
//GFX Plane Physical AddressS
#define SDP83_GFX1_PHYWINBASE 	(DDRB_BASE_ADDR+0x07900000)
//SP Plane Physical AddressS
#define SDP83_GFX2_PHYWINBASE 	(DDRB_BASE_ADDR+0x08900000)
