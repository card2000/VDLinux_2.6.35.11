 ...
 *
 ************************************************************************************/
#define R_MANUFACTURER_ID_SAMSUNG			0x00EC
 ...
 *
 ************************************************************************************/
#define R_COPY_BACK_PAGE_ADDR_MASK			(BIT7|BIT6|BIT5|BIT4|BIT3|BIT2)
#define R_COPY_BACK_SECTOR_ADDR_MASK		(BIT1|BIT0)
 ...
 *
 ******************************************/
#define R_NAND_PAGE_ADDR_MASK				(BIT7|BIT6|BIT5|BIT4|BIT3|BIT2)
#define R_NAND_SECTOR_ADDR_MASK				(BIT1|BIT0)
 ...
 *
 ************************************************************************************/
#define R_BOOTRAM_DATARAM_SEL				BIT11
#define R_DATA0_DATA1_SEL					BIT10
 ...
 *
 ************************************************************************************/
#define R_SYNCHRONOUS_READ					BIT15
#define R_ECC								BIT8
#define R_RDY_POLARITY						BIT7
#define R_INT_POLARITY						BIT6
#define R_IOBE								BIT5
#define R_RDY_CONF							BIT4
#define R_BWPS								BIT0
 ...
 *
 ************************************************************************************/
#define R_STATUS_ONGO						BIT15
#define R_STATUS_LOCK						BIT14
#define R_STATUS_LOAD						BIT13
#define R_STATUS_PROG						BIT12
#define R_STATUS_ERASE						BIT11
#define R_STATUS_ERROR						BIT10
#define R_STATUS_SUSPEND					BIT9
#define R_STATUS_RSTB						BIT7
#define R_STATUS_OTP_LOCK					BIT6
#define R_STATUS_1ST_BLOCK_OTP_LOCK			BIT5
#define R_STATUS_TIMEOUT					BIT0
 ...
 *
 ************************************************************************************/
#define R_INTERRUPT_INT						BIT15
#define R_INTERRUPT_RI						BIT7
#define R_INTERRUPT_WI						BIT6
#define R_INTERRUPT_EI						BIT5
#define R_INTERRUPT_RSTI					BIT4						
 ...
 *
 ************************************************************************************/
#define R_UNLOCK_STATUS						BIT2
#define R_LOCK_STATUS						BIT1
#define R_LOCK_TIGHT_STATUS					BIT0
...
// Changed by Mstar, define lock/unlock function for OneNAND/PCMCIA here.
