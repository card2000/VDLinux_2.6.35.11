...
#ifdef SAMSUNG_PATCH_WITH_HUB_BUGFIX
				/* bugfix : 2010-10-30 by Kim Kyung-Sik
				 * The TT's in some hubs malfunction when they
				 * receive this request following a STALL.
				 * Since a STALL can't leave the TT buffer in a busy
				 * state (Figures 11-48 - 11-51 in the USB 2.0 spec), 
				 * we won't clear the TT
				 * buffer in this case. 
				 */
				{				
...
#if _USB_A3_SHORT_PACKET_LOSE_INT_PATCH
