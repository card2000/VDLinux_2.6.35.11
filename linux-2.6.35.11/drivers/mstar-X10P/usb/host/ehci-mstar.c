...
void uranus_start_ehc1(struct platform_device *dev, unsigned int flag)
{
	...
	{
	writeb(readb((void*)0xbf804880)&~0x10,(void*)0xbf804880);	//EHCI Vbsu turn on
	}
	mdelay(2);
	...
	if ( !(flag & EHCFLAG_TESTPKG) )
	{
	writeb(readb((void*)0xbf804880)&~0x10,(void*)0xbf804880);
	}
...
void uranus_start_ehc2(struct platform_device *dev, unsigned int flag)
{
	...
	if ( !(flag & EHCFLAG_TESTPKG) )
	{
		writeb(readb((void*)0xbf801a80)&~0x10,(void*)0xbf801a80);	//EHCI Vbsu turn on
	}
	mdelay(2);
	...
	if ( !(flag & EHCFLAG_TESTPKG) )
	{
	writeb(readb((void*)0xbf801a80)&~0x10,(void*)0xbf801a80);
	}
...
void Titania3_series_start_ehc(unsigned int UTMI_base, unsigned int USBC_base, unsigned int UHC_base, unsigned int flag)
{
	...
	writeb(readb((void*)(USBC_base+0x02*2)) & ~0x03, (void*) (USBC_base+0x02*2)); //UHC select enable
	writeb(readb((void*)(USBC_base+0x02*2)) | 0x01, (void*) (USBC_base+0x02*2)); //UHC select enable

	writeb(readb((void*)(UHC_base+0x40*2)) & ~0x10, (void*) (UHC_base+0x40*2)); //0: VBUS On.
	mdelay(1);	// delay 1ms
