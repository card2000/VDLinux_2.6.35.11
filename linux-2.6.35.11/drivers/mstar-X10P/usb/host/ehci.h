		...
		__u32 __iomem * regs)
{
	...
	spin_lock_irqsave(&(hcd->usb_reset_lock), usb_reset_flags);
	...
	spin_unlock_irqrestore(&(hcd->usb_reset_lock), usb_reset_flags);
...
#else
#define STUB_DEBUG_FILES	//Colin, 101012, always stub debug files
#endif	/* DEBUG */
