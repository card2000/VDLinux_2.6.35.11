        ...
        xfs_split_data_t *split_data)
{
	...
	ASSERT(xfs_isilocked(ip, XFS_ILOCK_EXCL|XFS_IOLOCK_EXCL)); //Refer commit 579aa9caf552c639fc78168db4cfe7ffcf00c3b3
        ASSERT(*tp != NULL);
...
//        xfs_itrunc_trace(XFS_ITRUNC_FINISH1, ip, 0, new_size, start_offset, end_offset);
 ...
 *                                                                                                                                                       */
        ...
        ASSERT((new_size != 0) ||
               (fork == XFS_ATTR_FORK) ||
               (ip->i_d.di_nextents == 0));
        //xfs_itrunc_trace(XFS_ITRUNC_FINISH2, ip, 0, new_size, start_offset, end_offset);
        return 0;
}
