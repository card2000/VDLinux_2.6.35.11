...
static inline void arch_idle(void)
{
	...
	volatile unsigned int * const gic_pending_reg1 = (volatile unsigned int *) (VA_GIC_DIST_BASE + 0x200); 
	volatile unsigned int * const gic_pending_reg2 = (volatile unsigned int *) (VA_GIC_DIST_BASE + 0x204); 
	volatile unsigned int * const gic_pending_reg3 = (volatile unsigned int *) (VA_GIC_DIST_BASE + 0x208); 
	volatile unsigned int * const gic_pending_reg4 = (volatile unsigned int *) (VA_GIC_DIST_BASE + 0x20C); 
