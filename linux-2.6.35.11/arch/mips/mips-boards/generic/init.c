...
#if defined(CONFIG_MSTAR_OBERON) || defined(CONFIG_MSTAR_EUCLID) || defined(CONFIG_MSTAR_TITANIA3) || defined(CONFIG_MSTAR_URANUS4) || defined(CONFIG_MSTAR_TITANIA4) || defined(CONFIG_MSTAR_TITANIA8) || defined(CONFIG_MSTAR_TITANIA9) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_AMBER5)
    void init_chip_uart(void);
#endif

void __init prom_init(void)
{
#if defined(CONFIG_MSTAR_OBERON) || defined(CONFIG_MSTAR_URANUS4) || defined(CONFIG_MSTAR_TITANIA4) || defined(CONFIG_MSTAR_TITANIA8) || defined(CONFIG_MSTAR_TITANIA9) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_AMBER5)
    ...
    pr_info("\nLINUX started...\n");
#if defined(CONFIG_MSTAR_URANUS4_BD_FPGA) || defined(CONFIG_MSTAR_TITANIA4_BD_FPGA) || defined(CONFIG_MSTAR_TITANIA8_BD_FPGA) || defined(CONFIG_MSTAR_TITANIA9_BD_FPGA) || defined(CONFIG_MSTAR_AMBER1_FPGA) || defined(CONFIG_MSTAR_AMBER5_BD_FPGA)
