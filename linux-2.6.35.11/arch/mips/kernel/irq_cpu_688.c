...
#ifdef CONFIG_NVT_NT72688
	if(irq<=31)
		clear_bit(irq - NT72688_INT_BASE, (void *)ADDR_CPU0_IRQ_MASK_L);
	else
		clear_bit(irq - NT72688_INT_BASE2, (void *)ADDR_CPU0_IRQ_MASK_H);
	g_tmp1 = *(volatile unsigned long *)(0xbc0d000c);
...
#ifdef CONFIG_NVT_NT72688
	if(irq <= 31)
		set_bit(irq - NT72688_INT_BASE, (void *)ADDR_CPU0_IRQ_MASK_L);
	else
		set_bit(irq - NT72688_INT_BASE2, (void *)ADDR_CPU0_IRQ_MASK_H);
	g_tmp1 = *(volatile unsigned long *)(0xbc0d000c);
	__asm__ __volatile__("sync\n\t");
	iob();
#else 
...
#endif /* #ifndef CONFIG_NVT_NT72688 */
